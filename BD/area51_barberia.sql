...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-09-2025 a las 23:06:12
...
--
-- Base de datos: `area51_barbershop_2025`
--
...
(1, 'yeisonbarber.png', 'Yeison Sarmiento', 'Es un barbero excelente, con gran precisión en los cortes y un estilo moderno que encanta a los clientes. Su dedicación y creatividad hacen que cada visita sea una experiencia única y satisfactoria.', '3214732236', 'yeison.sarmiento@area51.com', '2024-12-05'),
(2, 'Rafael_Barrios.png', 'Rafael Barrios', 'Destaca por su técnica impecable y su pasión por ofrecer siempre un corte de calidad superior. Su compromiso con la perfección lo ha convertido en uno de los barberos más confiables y solicitados por los clientes.', '3214732236', 'rafael.barrios@area51.com', '2024-12-10'),
(3, 'Rafael_Jaime.png', 'Rafael Jaime', 'Es reconocido por su estilo detallista, garantizando siempre un acabado elegante y profesional. Su habilidad para adaptarse a las tendencias lo hace sobresalir como un referente en la barbería.', '3214732236', 'rafael.jaime@area51.com', '2024-12-15'),
(4, 'Samuel_Martinez.png', 'Samuel Martínez', 'Es un barbero con gran creatividad, logrando cortes únicos y personalizados que dejan huella en cada cliente. Su talento y carisma generan confianza, lo que hace que siempre sea altamente recomendado.', '3145678901', 'samuel.martinez@area51.com', '2024-12-18');
...
(108, 3, 4, 2, 'corte1.jpg', '2025-09-21', '16:00:00', 'pendiente', '2025-09-21 20:35:21'),
(109, 2, 4, 1, 'corte1.jpg', '2025-09-21', '15:00:00', 'pendiente', '2025-09-21 20:49:45');
...
(1, 'Carlos', 'Pérez', '3175625131', 'carlos.perez@gmail.com', '2025-01-05 10:00:00'),
...
(1, 'Noche de Estilo', 'Evento de cortes gratuitos para clientes VIP.', '2025-02-01', '2025-08-30 01:16:49', NULL),
(2, 'Taller de Barba', 'Capacitación sobre técnicas de afeitado.', '2025-02-05', '2025-08-30 01:16:49', NULL),
(3, 'Competencia de Barberos', 'Concurso entre barberos locales.', '2025-02-10', '2025-08-30 01:16:49', NULL),
(4, 'Charla de Estilismo', 'Conferencia sobre tendencias actuales.', '2025-02-12', '2025-08-30 01:16:49', NULL),
(5, 'Show en Vivo', 'Demostración de cortes modernos.', '2025-02-15', '2025-08-30 01:16:49', NULL),
(6, 'Semana del Cliente', 'Promociones y regalos para clientes frecuentes.', '2025-02-18', '2025-08-30 01:16:49', NULL),
(7, 'Feria de Belleza', 'Participación en feria local de estética.', '2025-02-20', '2025-08-30 01:16:49', NULL),
(8, 'Curso Intensivo', 'Entrenamiento para nuevos barberos.', '2025-02-25', '2025-08-30 01:16:49', NULL);
...
(2, 'diario', '2025-09-13', '2025-09-13', 25000.00, 1, '2025-09-13 22:13:06');
...
(1, 'Carlos', 'Parra', 'carlos.parra@example.com', 'Sugerencia', 'Solicito información sobre nuevos servicios y horario de atención.', '2025-09-12 02:26:47', 'Pendiente'),
(2, 'María', 'López', 'maria.lopez@example.com', 'Queja', 'No recibí la confirmación de mi cita.', '2025-09-12 02:26:47', 'En Proceso'),
(3, 'Juan', 'Rodríguez', 'juan.rodriguez@example.com', 'Reclamo', 'Mi servicio no se realizó correctamente.', '2025-09-12 02:26:47', 'Resuelto'),
(4, 'Ana', 'Gómez', 'ana.gomez@example.com', 'Sugerencia', 'Sería bueno ofrecer descuentos por fidelidad.', '2025-09-12 02:26:47', 'Resuelto'),
(5, 'Pedro', 'Martínez', 'pedro.martinez@example.com', 'Petición', 'Quisiera cambiar la fecha de mi cita.', '2025-09-12 02:26:47', 'Resuelto');
...
(1, 'corte1.jpg', 'Corte de Cabello', 'Corte de cabello diseñado para que destaques.', 15000.00, ''),
...
(7, 'paquete premium.jpg', 'Paquete Premium', 'Combinación de corte de cabello, arreglo de barba, limpieza facial y masaje relajante.', 50000.00, ''),
(8, 'keratina.jpg', 'Aplicación de Queratina', 'Renueva tu cabello con nuestra aplicación de queratina, dejándolo suave, brillante y manejable.', 0.00, 'Costo según el largo del cabello');
...
(1, 'https://www.tiktok.com/@ysarmiento.barber/video/7492250638236110086', '7492250638236110086', '', 'cp', '2025-08-30 06:48:49', 'activo'),
...
(3, 'El arte del cuidado', 'https://youtu.be/7_lQ_HQnMwY?si=JsMpORA77jeyLrLi', '2025-08-10 10:00:00', 'carlos', 'activo');
...
ALTER TABLE `citas`
  ...
  ADD KEY `fk_citas_barberos` (`id_barbero`),
...
ALTER TABLE `dashboard`
  ...
  ADD KEY `fk_dashboard_barberos` (`id_barbero`);
...
ALTER TABLE `eventos`
  ...
  ADD KEY `fk_eventos_admin` (`publicado_por`);
...
ALTER TABLE `noticias`
  ...
  ADD KEY `fk_noticias_publicado_por` (`publicado_por`);
...
--
ALTER TABLE `barberos`
  MODIFY `id_barbero` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `citas`
--
ALTER TABLE `citas`
  MODIFY `id_cita` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;
...
--
ALTER TABLE `citas`
  ADD CONSTRAINT `fk_citas_barberos` FOREIGN KEY (`id_barbero`) REFERENCES `barberos` (`id_barbero`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `fk_citas_servicios` FOREIGN KEY (`id_servicio`) REFERENCES `servicios` (`id_servicio`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `dashboard`
--
ALTER TABLE `dashboard`
  ADD CONSTRAINT `fk_dashboard_barberos` FOREIGN KEY (`id_barbero`) REFERENCES `barberos` (`id_barbero`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `eventos`
--
ALTER TABLE `eventos`
  ADD CONSTRAINT `fk_eventos_admin` FOREIGN KEY (`publicado_por`) REFERENCES `administradores` (`id_admin`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Filtros para la tabla `noticias`
--
ALTER TABLE `noticias`
  ADD CONSTRAINT `fk_noticias_publicado_por` FOREIGN KEY (`publicado_por`) REFERENCES `administradores` (`id_admin`) ON DELETE SET NULL ON UPDATE CASCADE;

DELIMITER $$
--
-- Eventos
--
CREATE DEFINER=`root`@`localhost` EVENT `actualizar_ingresos_diarios` ON SCHEDULE EVERY 1 DAY STARTS '2025-09-13 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
    DECLARE inicio DATE;
    DECLARE fin DATE;
