...
// si lo llamas desde index.php: $citas = $citasController->listar();
?>
<body>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <a href="index.php?page=editar_cita&id=<?= $cita['id_cita'] ?>" class="btn btn-warning btn-sm">Editar</a>
                                <a href="index.php?page=eliminar_cita&id=<?= $cita['id_cita'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Eliminar esta cita?')">Eliminar</a>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach; ?>
